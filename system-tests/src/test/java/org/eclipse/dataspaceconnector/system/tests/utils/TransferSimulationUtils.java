...
public abstract class TransferSimulationUtils {
    ...
    public static final String PROVIDER_ASSET_ID = "company1-test-document";
    public static final String EU_RESTRICTED_PROVIDER_ASSET_ID = "company1-test-document-2";
